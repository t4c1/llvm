...
public:
  ...
  unsigned getCallArgumentMemCost() const;
...
public:
  ...
  virtual unsigned getCallArgumentMemCost() = 0;
...
public:
  ...
  unsigned getCallArgumentMemCost() override {
    return Impl.getCallArgumentMemCost();
  }
